    ...
    layui.use(['layer','table'], function(){
        ...
        tableIns=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'ship', title:'生产地'}
                ,{field:'delivery', title:'收货地址'}
                ,{field:'logistics', title:'物流'}
        ...
        table.on('tool(hangleTable)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
    ...
    if(null!=id){
        if(currentUser==id){
            ...
            layer.confirm('您确定要删除'+id+'用户吗？', {
                ...
                $.post("/HangleDeleteByName",{"id":id},function(data){
                    if(isLogin(data)){
                        if(data=="ok"){
                            //回调弹框
